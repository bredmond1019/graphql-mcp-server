...
class MCPToolTester:
                        ...
                        "matches": [
                            {
                                ...
                                "context": m.context_before + m.context_after if m.context_before else []
        ...
        tests = [
            {
                ...
                "args": {"workflow": "patient_management", "include_variables": True}
            },
            {
                "name": "Appointment scheduling workflow", 
                "args": {"workflow": "appointment_scheduling", "include_variables": True}
            },
            {
                "name": "Billing and payments workflow",
                "args": {"workflow": "billing_and_payments", "include_variables": False}
            }
        ]
        ...
        tests = [
            {
                ...
                "args": {"operation": "create_patient", "language": "javascript"}
            },
            {
                "name": "Book appointment (Python)",
                "args": {"operation": "book_appointment", "language": "python"}
            },
            {
                "name": "Update insurance (cURL)",
                "args": {"operation": "update_insurance", "language": "curl"}
            }
        ]
        ...
        tests = [
            {
                ...
                "args": {"type_name": "Patient"}
            },
            {
                "name": "Appointment type details",
                "args": {"type_name": "Appointment"}
            },
            {
        ...
        tests = [
            {
                ...
                "args": {"error_message": "Field 'role' doesn't exist on type 'User'"}
            },
            {
                "name": "Unauthorized error",
                "args": {"error_message": "Unauthorized: Must be logged in"}
            },
            {
                "name": "Validation failed error",
                "args": {"error_message": "Validation failed: Email already exists"}
            }
        ]
            ...
            try:
                ...
                results.append({
                    ...
                    "output": {
                        ...
                        "solutions": result.solutions[:3],  # First 3 solutions
                        "example": result.example[:200] + "..." if result.example and len(result.example) > 200 else result.example
                    },
                    "success": True
                })
    ...
    def _generate_analysis(self, all_results):
        ...
        content += "and better adherence to best practices. The 100% success rate in testing demonstrates "
